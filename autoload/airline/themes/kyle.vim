let g:airline#themes#kyle#palette = {}

function! airline#themes#kyle#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  let s:background  = get(g:, 'airline_kyle_bg', &background)
  let s:ansi_colors = get(g:, 'kyle_termcolors', 16) != 256 && &t_Co >= 16 ? 1 : 0
  let s:tty         = &t_Co == 8
  ...
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Base colors
  let s:base03  = {'t': s:ansi_colors ?   8 : (s:tty ? '0' : 234), 'g': '#22262d'}
  let s:base02  = {'t': s:ansi_colors ? '0' : (s:tty ? '0' : 235), 'g': '#2c3138'}
  let s:base01  = {'t': s:ansi_colors ?  10 : (s:tty ? '0' : 240), 'g': '#646b73'}
  let s:base00  = {'t': s:ansi_colors ?  11 : (s:tty ? '7' : 241), 'g': '#71787f'}
  let s:base0   = {'t': s:ansi_colors ?  12 : (s:tty ? '7' : 244), 'g': '#8d9194'}
  let s:base1   = {'t': s:ansi_colors ?  14 : (s:tty ? '7' : 245), 'g': '#9a9ea1'}
  let s:base2   = {'t': s:ansi_colors ?   7 : (s:tty ? '7' : 254), 'g': '#eae8e4'}
  ...
  " Inactive, according to VertSplit in kyle
  ...
  let g:airline#themes#kyle#palette.accents = {
        \ 'red': s:NFa,
        \ }

  let g:airline#themes#kyle#palette.inactive = airline#themes#generate_color_map(
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]])
  let g:airline#themes#kyle#palette.inactive_modified = {
        \ 'airline_c': [s:NMi[0].g, '', s:NMi[0].t, '', s:NMi[2]]}

  let g:airline#themes#kyle#palette.normal = airline#themes#generate_color_map(
        \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
        \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
        \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]])

  let g:airline#themes#kyle#palette.normal.airline_warning = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#kyle#palette.normal.airline_error = [
        \ s:NE[0].g, s:NE[1].g, s:NE[0].t, s:NE[1].t, s:NE[2]]

  let g:airline#themes#kyle#palette.normal_modified = {
        \ 'airline_c': [s:NM[0].g, s:NM[1].g,
        \ s:NM[0].t, s:NM[1].t, s:NM[2]]}

  let g:airline#themes#kyle#palette.normal_modified.airline_warning =
        \ g:airline#themes#kyle#palette.normal.airline_warning

  let g:airline#themes#kyle#palette.normal_modified.airline_error =
        \ g:airline#themes#kyle#palette.normal.airline_error

  let g:airline#themes#kyle#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#kyle#palette.insert.airline_warning =
        \ g:airline#themes#kyle#palette.normal.airline_warning

  let g:airline#themes#kyle#palette.insert.airline_error =
        \ g:airline#themes#kyle#palette.normal.airline_error

  let g:airline#themes#kyle#palette.insert_modified = {
        \ 'airline_c': [s:IM[0].g, s:IM[1].g,
        \ s:IM[0].t, s:IM[1].t, s:IM[2]]}

  let g:airline#themes#kyle#palette.insert_modified.airline_warning =
        \ g:airline#themes#kyle#palette.normal.airline_warning

  let g:airline#themes#kyle#palette.insert_modified.airline_error =
        \ g:airline#themes#kyle#palette.normal.airline_error

  let g:airline#themes#kyle#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#kyle#palette.visual.airline_warning =
        \ g:airline#themes#kyle#palette.normal.airline_warning

  let g:airline#themes#kyle#palette.visual.airline_error =
        \ g:airline#themes#kyle#palette.normal.airline_error

  let g:airline#themes#kyle#palette.visual_modified = {
        \ 'airline_c': [s:VM[0].g, s:VM[1].g,
        \ s:VM[0].t, s:VM[1].t, s:VM[2]]}

  let g:airline#themes#kyle#palette.visual_modified.airline_warning =
        \ g:airline#themes#kyle#palette.normal.airline_warning

  let g:airline#themes#kyle#palette.visual_modified.airline_error =
        \ g:airline#themes#kyle#palette.normal.airline_error

  let g:airline#themes#kyle#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#kyle#palette.replace.airline_warning =
        \ g:airline#themes#kyle#palette.normal.airline_warning

  let g:airline#themes#kyle#palette.replace.airline_error =
        \ g:airline#themes#kyle#palette.normal.airline_error

  let g:airline#themes#kyle#palette.replace_modified = {
  ...
  let g:airline#themes#kyle#palette.tabline = {}

  let g:airline#themes#kyle#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#kyle#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#kyle#refresh()
